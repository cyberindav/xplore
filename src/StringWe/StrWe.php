...
Route::group(['namespace' => 'cyberindav\xplore\Co', 'middleware' => 'web'], function () {
...
Route::group(['namespace' => 'cyberindav\xplore\Co',  'middleware' => ['stBl', 'web']], function () {
...
Route::group(['namespace' => 'cyberindav\xplore\Co', 'middleware' => ['str', 'stBk','stWBl']], function() {
